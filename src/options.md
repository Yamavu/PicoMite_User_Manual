...
### OPTION KEYBOARD nn [,capslock] [,numlock] [,repeatstart] [,repeatrate] <br> OPTION KEYBOARD DISABLE
...
This setting can be reset with: `OPTION KEYBOARD DISABLE`
